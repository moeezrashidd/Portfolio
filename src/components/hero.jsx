import { rectangle1, add, triangle, circle, vector, frame, me, rectangle2, imgBG , my } from "../assets"
    ...
    return (
        <>
            <div className="container flex justify-between items-center flex-col gap-5 md:flex-row  mx-auto  md:my-14">
                ...
                <div className="Hero-text flex flex-col w-full md:w-2/5 gap-7 py-4 z-40 h-full justify-center items-center md:items-start  "  >
                ...
                <div className="photo md:w-1/2 w-full  h-full py-4  relative flex justify-center items-center flex-col z-50 ">
                    ...
                    <div className="my-img   sm:w-[256px] sm:h-[245px] w-[220px] h-[220px] absolute  sm:top-20  rotate-[24.2deg] rounded-2xl sm:ml-8 bg-cover overflow-hidden   " style={{ backgroundImage: `url(${imgBG})` }}>
                        ...
                        >  <img src={my} alt="" className="rounded-2xl rotate-[-24.2deg]  sm:w-[256px]" /></motion.div>
                    </div>
